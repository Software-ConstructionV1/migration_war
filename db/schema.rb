...
ActiveRecord::Schema[7.1].define(version: 2026_06_06_193504) do
  create_table "posts", force: :cascade do |t|
    ...
    t.string "AhmedAdel"
    t.string "Abdelhamid_habsa_and_omar_adel_and_saadani"
    ...
    t.string "shadow_garden_renamed_by_ahmed_rabie"
